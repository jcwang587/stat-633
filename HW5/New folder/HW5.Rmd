...
output: 
  ioslides_presentation:
    widescreen: yes
    css: styles.css
runtime: shiny # *****Please comment out this line to generate a static html*****
---
...
- The dataset contains 133 countries
  ...
  - Kosovo, Hong Kong, State of Taiwan and Palestine were dropped because from 
  the dataset because the country statistics dataset did not have values for them
