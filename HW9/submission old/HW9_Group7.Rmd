...
- How are Shinkansen stations distributed geographically across Japan?
- What is the relationship between the year of opening and the distance from Tokyo Station?
...
## Graph Visualization of Shinkansen System
```{r, echo=FALSE, warning=FALSE, message=FALSE}
...
- Box plot - Study on the operating companies
- Map plot - Expansion of Shinkansen System
- Graph plot - Relationship between the stations and the distance to Tokyo
